...
export const DATA_SOURCES: Record<string, DataSourceDef> = {
  ...
  oura: {
    ...
    signals: ['sleep_duration', 'sleep_quality', 'hrv_rmssd', 'resting_hr', 'recovery_score', 'respiratory_rate', 'spo2'],
    cadence: 'daily',
    authType: 'oauth2',
  ...
  whoop: {
    ...
    signals: ['strain_score', 'recovery_score', 'sleep_duration', 'sleep_quality', 'hrv_rmssd', 'resting_hr', 'spo2', 'respiratory_rate'],
    cadence: 'daily',
    authType: 'oauth2',
    integrationStatus: 'planned',
  },
  garmin: {
    ...
    signals: ['resting_hr', 'hrv_rmssd', 'sleep_duration', 'sleep_quality', 'active_calories', 'steps', 'strain_score', 'vo2_max', 'respiratory_rate', 'spo2', 'body_weight', 'resting_bp_systolic', 'resting_bp_diastolic'],
    cadence: 'daily',
    authType: 'oauth2',
    integrationStatus: 'planned',
  },
  apple_watch: {
    ...
    signals: ['resting_hr', 'hrv_rmssd', 'active_calories', 'steps', 'sleep_duration', 'spo2', 'respiratory_rate', 'vo2_max'],
    cadence: 'daily',
    authType: 'oauth2',
    integrationStatus: 'planned',
  },
  fitbit: {
    ...
    signals: ['resting_hr', 'hrv_rmssd', 'sleep_duration', 'sleep_quality', 'active_calories', 'steps', 'recovery_score', 'spo2'],
    cadence: 'daily',
    authType: 'oauth2',
    integrationStatus: 'planned',
  },
  samsung_health: {
    ...
    signals: ['resting_hr', 'sleep_duration', 'active_calories', 'steps', 'spo2', 'body_weight'],
    cadence: 'daily',
    authType: 'oauth2',
  ...
  function_health: {
    ...
    signals: ['lab_a1c', 'lab_testosterone', 'lab_crp', 'lab_vitamin_d', 'lab_cortisol', 'lab_thyroid_tsh', 'lab_hemoglobin', 'lab_hematocrit', 'lab_ferritin', 'lab_iron', 'lab_transferrin_sat', 'lab_creatine_kinase', 'lab_fasting_glucose', 'lab_apob', 'lab_omega3_index'],
    cadence: 'periodic',
    authType: 'api_key',
    integrationStatus: 'planned',
  },
  ...
  levels_health: {
    label: 'Levels Health',
    category: 'wearable',
    description: 'CGM-based glucose monitoring with metabolic fitness scoring. Real-time glucose, glucose variability, and zone analysis.',
    signals: ['lab_fasting_glucose'],
    cadence: 'continuous',
    authType: 'oauth2',
    integrationStatus: 'future',
  },
  stelo: {
    label: 'Dexcom Stelo',
    category: 'wearable',
    description: 'Over-the-counter CGM. 15-day sensor with glucose readings every 5 minutes. No prescription required.',
    signals: ['lab_fasting_glucose'],
    cadence: 'continuous',
    authType: 'oauth2',
    integrationStatus: 'future',
  ...
  freestyle_libre: {
    ...
    category: 'wearable',
    description: 'Flash glucose monitoring with 14-day sensor. LibreView cloud API for data export.',
    signals: ['lab_fasting_glucose'],
    cadence: 'continuous',
    authType: 'api_key',
    integrationStatus: 'future',
